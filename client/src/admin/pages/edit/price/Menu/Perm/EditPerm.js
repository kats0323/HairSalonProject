...
class EditPerm extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('/perm/' + this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('/perm/update/' + this.props.match.params.id, perm)
            ...
            return (
                <div>
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group">
                            <input type="submit" value="Edit Perm" className="btn btn-primary" />
                        </div>
                    </form>
                </div>
            )
