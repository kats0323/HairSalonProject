...
class EditColor extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('/color/' + this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('/color/update/' + this.props.match.params.id, color)
            ...
            return (
                <div>
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group">
                            <input type="submit" value="Edit Color" className="btn btn-primary" />
                        </div>
                    </form>
                </div>
            )
