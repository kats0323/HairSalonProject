                ...
                <div className="menu_price container">
                    <Link to="/services/cut">
                        ...
                        <div className="menu_cut_img">
                            ...
                            <img src={process.env.PUBLIC_URL + '/img/more_info.jpg'} alt="" className="active_cut"></img>
                        </div>
                    </Link>
                    ...
                    <Link to="/services/color">
                        ...
                        <div className="menu_color_img">
                            ...
                            <img src={process.env.PUBLIC_URL + '/img/more_info.jpg'} alt="" className="active_color"></img>
                        </div>
                    </Link>
                    ...
                    <Link to="/services/perm">
                        ...
                        <div className="menu_perm_img" >
                            ...
                            <img src={process.env.PUBLIC_URL + '/img/more_info.jpg'} alt="" className="active_perm"></img>
                        </div>
                    </Link>
