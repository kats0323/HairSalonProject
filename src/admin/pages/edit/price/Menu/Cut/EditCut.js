...
class EditCut extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        ...
        axios.get('/cut/' + this.props.match.params.id)
            .then(response => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post('/cut/update/' + this.props.match.params.id, cut)
            ...
            return (
                <div>
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group">
                            <input type="submit" value="Edit Cut" className="btn btn-primary" />
                        </div>
                    </form>
                </div>
            )
...
export default connect(mapStateToProps)(EditCut);
